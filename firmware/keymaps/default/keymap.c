...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        LSFT_T(KC_Z), KC_X, KC_C,    KC_V,    KC_B,           KC_N,          KC_M,          KC_COMMA, KC_DOT, RSFT_T(KC_SLSH),
                            KC_LCTL, KC_LALT, LT(_NUM, KC_TAB),LGUI_T(KC_SPC), LT(_SYM, KC_ENT), RCTL(KC_ESC)
    ),
    ...
    [2] = LAYOUT_split_3x5_3(
        ...
        KC_LSFT, DF(_BASE),   DF(_COLEMAK),   KC_NO,   MO(_FUN),          KC_NO,   KC_NO,   KC_COMM,                   KC_DOT,  RSFT_T(KC_SLSH),
                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS
    ),
